				...
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?= isset($_GET['id']) ? "Edit Category" : "Add New Category" ?></h3>
						</div>
						<div class="panel-body">
							...
							<form method="post" id="postForm">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="categoryName" name="categoryName" value="<?= isset($categoryDetails) ? htmlspecialchars($categoryDetails['name']) : ""; ?>" placeholder="Category name..">
								</div>
